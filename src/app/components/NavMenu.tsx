...
const menuGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Lançamento de Notas", key: "lancamento-notas", component: () => <div>Em desenvolvimento...</div> },
    ],
  },
];
...
export function SidebarTurmas() {
  ...
  const [selectedKey, setSelectedKey] = useState<string>("dashboard"); // Mudando o padrão para dashboard
